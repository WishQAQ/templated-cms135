    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['preimg'] = "<a class=\"work_next\" href='$mlink'><img src=\"/skin/default/images/next_btn.png\" alt=\"{$preRow['title']}\"/></a> "; 
            }
            else
            {
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['nextimg'] = "<a class=\"work_prev\" href='$mlink'><img src=\"/skin/default/images/prev_btn.png\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
