...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<em><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></em>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<em><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></em>\r\n";
        }
        $purl = $this->GetCurUrl();
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<em><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></em>\r\n";
            $indexpage="<em><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></em>\r\n";
        }
        else
        {
            $indexpage="<em>首页</em>\r\n";
        ...
        {
            $nextpage.="<em><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></em>\r\n";
            $endpage="<em><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></em>\r\n";
        }
        else
        {
            $endpage="<em>末页</em>\r\n";
        ...
        $optionlist = "<em><select name='sldd' style='width:{$optionlen}px' onchange='location.href=this.options[this.selectedIndex].value;'>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<em id=\"pa_hover\"><a>$j</a></em>\r\n";
            }
            else
            {
                $listdd.="<em><a href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a></em>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<em><span class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</span></em>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<em><span class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</span></em>\r\n";
        }
        $maininfo = "<em><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></em>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<em><a href='".$purl."PageNo=$prepagenum'>上一页</a></em>\r\n";
            $indexpage="<em><a href='".$purl."PageNo=1'>首页</a></em>\r\n";
        }
        else
        {
            $indexpage="<em><a>首页</a></em>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<em><a href='".$purl."PageNo=$nextpagenum'>下一页</a></em>\r\n";
            $endpage="<em><a href='".$purl."PageNo=$totalpage'>末页</a></em>\r\n";
        }
        else
        {
            $endpage="<em><a>末页</a></em>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"thisclass\"><a>$j</a></em>\r\n";
            }
            else
            {
                $listdd.="<em><a href='".$purl."PageNo=$j'>".$j."</a></em>\r\n";
            }
        }
